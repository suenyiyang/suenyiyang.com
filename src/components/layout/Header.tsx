...
export default function Header() {
  return (
    <header className="w-full py-4 px-4 md:py-5 md:pr-16 text-text-secondary dark:text-text-secondary-dark sticky top-0 z-10 backdrop-blur-md bg-bg-light/85 dark:bg-bg-dark/85">
